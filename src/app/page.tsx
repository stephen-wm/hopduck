		...
		<div className="flex flex-col flex-1 bg-background">
			...
			<main className="flex-1 grid place-items-center">
				<div className="p-4 flex flex-col gap-2 items-center text-center">
					<h1 className="text-3xl lg:text-4xl text-medium text-foreground tracking-tight leading-10 text-balance" style={{ fontWeight: '500' }}>Something great is on its way.</h1>

					<p className="text-lg leading-8 text-zinc-600 dark:text-zinc-400 text-balance max-w-md md:max-w-max">
						To learn more about this project, visit the <Link href="https://github.com/stephen-wm/hopduck#README" className="text-white underline underline-offset-8 decoration-transparent hover:underline-offset-5 hover:decoration-white transition-all duration-150">GitHub repository</Link>.
					</p>
				</div>
			</main>
